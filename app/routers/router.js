...
router.get('/api/depart/onebyid/:id_d', depart.getDepartById);
router.put('/api/depart/update/:id_d', depart.updateById);
router.delete('/api/depart/delete/:id_d', depart.deleteById);
...
router.post('/api/invodeta/create', invdetail.create);
router.get('/api/invodeta/all', invdetail.retrieveAllDetails);
router.get('/api/invodeta/onebyid/:id_factura', invdetail.getDetailById);
router.put('/api/invodeta/update/:id_factura', invdetail.updateById);
router.delete('/api/invodeta/delete/:id_factura', invdetail.deleteById);
